...
title: Printhead including a looped heater element
...
url: http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=1&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=1&f=G&l=50&d=PALL&S1=07717543&OS=07717543&RS=07717543
...
Alternatively the drive circuitry for one unit cell is not on opposing sides of the heater element that it controls. All the drive circuitry for the heater of one unit cell is in a single undivided area that is offset from the heater. That is the drive circuitry is partially overlaid by one of the electrodes of the heater that it is controlling and partially overlaid by one or more of the heater electrodes from adjacent unit cells. In this situation the center of the drive circuitry is less than microns from the center of the associate nozzle aperture . In most Memjet printheads of this type the offset is less than 100 microns and in many cases less than 50 microns preferably less than 30 microns.
